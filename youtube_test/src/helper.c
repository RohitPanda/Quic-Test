...
void printhelp(char * name)
{
	...
	printf("\n");
    printf("\t--p [port1,port2,port3] => for instance --p 3039,3040 list of preferred port numbers (better more then 1024)\n");
    printf("\n");
    printf("\t--qver quic_version_string => quic_version, Q039-Q042, by default Q039\n");
    printf("\n");
    printf("\t--debug => turn on debug mode with quic client full debug output\n");
    printf("\n");
    printf("\t--single_stream => use only one stream per connection\n");
    printf("\n");
...
void print_help_output()
{
    puts("\n"
         ...
         "    QUIC connect time to the Video CDN\n"
         "    Advertised bitrate of the downloaded video\n"
         "    Video stream used QUIC version\n"
         "    Video stream last HTTP header version\n"
         "    AUDIO => Fixed\n"
         ...
         "    QUIC connect time to the audio CDN\n"
         "    Advertised bitrate of the downloaded audio\n"
         "    Audio stream used QUIC version\n"
         "    Audio stream last HTTP header version\n"
         "    QUIC connect time to the YouTube server (primary URL)\n"
